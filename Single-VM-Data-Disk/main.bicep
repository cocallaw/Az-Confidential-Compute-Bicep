...
var diskEncryptSetNameData = 'DES-Data-01'
...
module DiskEncryption './DiskEncryption.bicep' = {
  ...
  params: {
    ...
    diskEncryptSetNameData: diskEncryptSetNameData
...
resource nic01 'Microsoft.Network/networkInterfaces@2019-02-01' = {
...
resource accVM01 'Microsoft.Compute/virtualMachines@2021-11-01' = {
  ...
  properties: {
    ...
    storageProfile: {
      ...
      dataDisks: [
        {
          lun: 0
          name: '${virtualMachineBaseName}-datadisk-01'
          createOption: 'Empty'
          diskSizeGB: 128
          managedDisk: {
            storageAccountType: 'Premium_LRS'
            diskEncryptionSet: {
              id: resourceId('Microsoft.Compute/diskEncryptionSets', diskEncryptSetNameData)
            }
          }
        }
      ]
